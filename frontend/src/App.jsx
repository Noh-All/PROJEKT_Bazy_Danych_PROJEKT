      ...
      <nav className="bg-gray-900 text-white p-4 shadow-lg">
        <div className="container mx-auto flex justify-between items-center">
          ...
          <div className="space-x-6 text-sm font-medium">
            ...
            <button className="bg-orange-600 px-4 py-2 rounded-lg hover:bg-orange-700">Zaloguj</button>
          </div>
        </div>
      </nav>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-white p-8 rounded-2xl shadow-xl mb-10">
            ...
            <form onSubmit={handleSearch} className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <button type="submit" className="bg-orange-500 text-white font-bold py-4 rounded-xl hover:bg-orange-600 transition shadow-lg shadow-orange-200">
                Szukaj połączenia
              </button>
            </form>
          </div>
            ...
            {!loading && wyniki.map((wynik) => (
              <div key={wynik.id} className="bg-white p-6 rounded-2xl shadow-md border-l-8 border-orange-500 flex flex-col md:flex-row justify-between items-center hover:shadow-lg transition">
                ...
                <div className="flex items-center gap-6">
                  ...
                  <button className="bg-gray-900 text-white px-8 py-3 rounded-xl font-bold hover:bg-orange-500 transition">
                    KUP BILET
                  </button>
                </div>
              </div>
